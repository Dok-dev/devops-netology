...
6. Дополните README.md, протестируйте playbook, выложите новую версию в github. В ответ предоставьте ссылку на репозиторий.
   ...
   >>**Выполнение:**   
```
vagrant@vagrant:/mnt/prime/hw-08.2_Ansible-2-playbook/playbook$ ansible-playbook site.yml -i inventory/prod.yml
...
TASK [Create directrory for Logstash] ************************************************************************************************************************************************************
ok: [logstash1]
...
TASK [Make Logstash config] **********************************************************************************************************************************************************************
changed: [logstash1]

PLAY RECAP ***************************************************************************************************************************************************************************************
elasticsearch1             : ok=13   changed=0    unreachable=0    failed=0    skipped=3    rescued=0    ignored=0
logstash1                  : ok=10   changed=1    unreachable=0    failed=0    skipped=2    rescued=0    ignored=0
```
...
Рассмотрю некоторые задания, к которым у меня есть комментарии, остальные задания засчитаны без комментариев
Отдельно отмечу успешное выполнение задания по Logstash
